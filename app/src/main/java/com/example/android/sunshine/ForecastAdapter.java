...
//      DONE (7) Replace the single TextView with Views to display all of the weather info
        ...
        forecastAdapterViewHolder.mDescription.setContentDescription(descriptionA11y);
        ...
        String highA11y = mContext.getString(R.string.a11y_high_temp, highString);
         ...
         /* Set the text and content description (for accessibility purposes) */
        forecastAdapterViewHolder.mHighTemperature.setText(highString);
        ...
        String lowA11y = mContext.getString(R.string.a11y_low_temp, lowString);
         ...
         /* Set the text and content description (for accessibility purposes) */
        forecastAdapterViewHolder.mLowTemperature.setText(lowString);
        forecastAdapterViewHolder.mLowTemperature.setContentDescription(lowA11y);
    }
